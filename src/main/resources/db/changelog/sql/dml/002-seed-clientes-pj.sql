...
VALUES (11, gen_random_uuid(), 'PJ', 'contato@moveisestrela.com.br', 'CONSIGNANTE', 'PARCEIRO', 12, 85000.00, NOW() - INTERVAL '120 days', true, NOW(), NOW());
...
VALUES (12, gen_random_uuid(), 'PJ', 'compras@techsolutions.com.br', 'COMPRADOR', 'GOOGLE_ADS', 'google', 6, 45000.00, NOW() - INTERVAL '60 days', NOW() - INTERVAL '5 days', true, NOW(), NOW());
...
INSERT INTO clientes (id, public_id, dtype, email, tipo_cliente, origem_lead, total_compras_realizadas, total_vendas_realizadas, valor_total_comprado, valor_total_vendido, ativo, data_criacao, data_atualizacao)
VALUES (13, gen_random_uuid(), 'PJ', 'financeiro@construtoraera.com.br', 'AMBOS', 'INDICACAO', 4, 8, 28000.00, 52000.00, true, NOW(), NOW());
...
INSERT INTO clientes (id, public_id, dtype, email, tipo_cliente, origem_lead, observacoes, ativo, data_criacao, data_atualizacao)
VALUES (14, gen_random_uuid(), 'PJ', 'contato@designinteriores.com.br', 'PARCEIRO', 'BOCA_A_BOCA', 'Parceiro de design de interiores - pode indicar clientes', true, NOW(), NOW());
...
VALUES (15, gen_random_uuid(), 'PJ', 'gerencia@hotelboavista.com.br', 'PROSPECTO', 'GOOGLE_ADS', 'google', 'campanha-hotelaria', 'Interessado em mobiliário para renovação de 50 quartos', true, NOW(), NOW());
